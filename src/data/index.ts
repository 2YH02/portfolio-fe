  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Quill.js를 프로젝트 디자인에 맞춰 커스텀 스타일로 구성하고, 이미지 업로드 시 로딩 UI가 표시되도록 블록 클래스를 확장했습니다.",
          "이미지 업로드는 Supabase Storage와 연동하였으며, 삭제 처리와 함께 blur 이미지까지 자동 저장되도록 구현해 UX를 향상시켰습니다.",
        ],
      },
      {
        title: "블로그 글 렌더링 컴포넌트 및 코드 블럭 하이라이팅",
        bullets: [
          "Quill 에디터에서 저장된 HTML 콘텐츠를 파싱하여 렌더링하는 컴포넌트를 제작하고, highlight.js를 기반으로 프로젝트 스타일에 맞춘 코드 하이라이팅을 구현했습니다.",
        ],
      },
      {
        title: "Framer Motion 기반 인터랙티브 UI 구현",
        bullets: [
          "페이지 전환 및 주요 요소 등장 시 Framer Motion을 활용한 애니메이션을 적용하여 자연스러운 사용자 경험을 제공했습니다.",
          "이미지 로딩 시 blur placeholder를 함께 적용하여 체감 성능을 향상시켰습니다.",
        ],
      },
      {
        title: "블로그 페이지네이션 및 SEO 최적화",
        bullets: [
          "Rust 백엔드에서 OFFSET/LIMIT 기반의 서버 페이지네이션 기능을 구현하고, Next.js에서 동적 라우팅과 SSR을 통해 글 목록을 효율적으로 불러왔습니다.",
          "정적 페이지 생성(SSG)과 SSR을 병행하고, 동적 sitemap.ts 및 robots.txt를 구성하여 Google/Naver Search Console에 등록해 검색 엔진 최적화를 수행했습니다.",
        ],
      },
    ],
